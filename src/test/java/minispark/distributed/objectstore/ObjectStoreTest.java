...
class ObjectStoreTest {
    ...
    void shouldPutAndGetObject() throws Exception {
        ...
        EventLoopRunner.runUntil(messageBus, () -> getFuture.isDone(), java.time.Duration.ofSeconds(5));
    ...
    void shouldDeleteObject() throws Exception {
        ...
        EventLoopRunner.runUntil(messageBus, () -> deleteFuture.isDone(), java.time.Duration.ofSeconds(5));
        deleteFuture.get();
    ...
    void shouldListObjects() throws Exception {
        ...
        EventLoopRunner.runUntil(messageBus, () -> put1Future.isDone(), java.time.Duration.ofSeconds(5));
        put1Future.get();
        
        CompletableFuture<Void> put2Future = client.putObject("key2", "data2".getBytes());
        EventLoopRunner.runUntil(messageBus, () -> put2Future.isDone(), java.time.Duration.ofSeconds(5));
        put2Future.get();

        // Get list of objects
        CompletableFuture<List<String>> listFuture = client.listObjects("");
        EventLoopRunner.runUntil(messageBus, () -> listFuture.isDone(), java.time.Duration.ofSeconds(5));
